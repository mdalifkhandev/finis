...
import { approveAdminExpense, createAdminExpense, deleteAdminExpense, ExpenseFilters, ExpensePayload, getAdminExpenses, getAdminExpenseSummary, markAdminExpensePaid, rejectAdminExpense, submitAdminExpense, updateAdminExpense } from "@/api/admin/expenses.api";
...
export function useCreateAdminExpenseMutation() { return useExpenseMutation((payload: ExpensePayload) => createAdminExpense(payload), "Expense saved"); }
export function useUpdateAdminExpenseMutation() { return useExpenseMutation(({ id, payload }: { id: string; payload: Partial<ExpensePayload> }) => updateAdminExpense(id, payload), "Expense updated"); }
