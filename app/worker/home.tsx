...
const WEEKLY_ACTIVITY = [
    ...
    { day: 'Tuesday', status: '2h 34m (In Progress)', type: 'in-progress' as const },
    ...
    return (
        <SafeAreaView edges={['top']} className="flex-1 bg-white">
            <ScrollView showsVerticalScrollIndicator={false} className="flex-1">
                ...
                <View className="mt-6">
                    <SectionHeader title="Today's Tasks" actionLabel="View All" onPressAction={() => { }} />
                    <View className="mt-2">
                        {MOCK_TASKS.map((task) => (
                            <WorkerTaskCard
                                key={task.id}
                ...
                <View className="mt-4 pb-10">
                    <SectionHeader title="This Week" actionLabel="View All" onPressAction={() => { }} />
