    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: THEME.colors.white }} edges={['top']}>
            ...
            <View style={{
                ...
                <Text style={{ fontSize: 18, fontWeight: '700', color: THEME.colors.textMain }}>Change Password</Text>
            </View>
            ...
            >
                ...
                <View style={{ paddingHorizontal: 20, paddingBottom: 24 }}>
                    <TouchableOpacity
                        ...
                        onPress={() => router.back()}
                    >
                        <Text style={{ color: 'white', fontSize: 18, fontWeight: '700' }}>Update password</Text>
                    </TouchableOpacity>
                </View>
            </KeyboardAvoidingView>
        </SafeAreaView>
