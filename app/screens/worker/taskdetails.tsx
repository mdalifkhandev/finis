...
const TaskDetailsScreen = () => {
    ...
    const handleComplete = () => {
        const taskData = {
            ...
            inventoryUsed: inventoryItems.filter(item => item.checked).map(item => ({
                id: item.id,
                name: item.name,
        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: THEME.colors.background }}>
            ...
            >
                        ...
                        <View>
                            <View style={{
                                ...
                                <TextInput
                                    ...
                                    style={{ flex: 1, marginLeft: 12, fontSize: 16, color: '#64748B' }}
                                    value={searchQuery}
                                ...
                                {filteredInventoryItems.map(item => (
                                    <View key={item.id} style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                                        <View style={{ flexDirection: 'row', alignItems: 'center', flex: 1 }}>
                                            ...
                                            <Text style={{ marginLeft: 16, fontSize: 18, fontWeight: '500', color: '#475569' }}>{item.name}</Text>
                                        </View>
                                        ...
                                        <View style={{
                                            ...
                                            <TouchableOpacity
                                                ...
                                                style={{ width: 36, height: 36, backgroundColor: 'white', borderRadius: 8, alignItems: 'center', justifyContent: 'center' }}
                                            >
                                                <Ionicons name="remove-outline" size={20} color="#0088CC" />
                                            </TouchableOpacity>

                                            <Text style={{ fontSize: 18, fontWeight: '600', color: '#1D4F6D', marginHorizontal: 12 }}>{item.quantity}</Text>

                                            <TouchableOpacity
                                                onPress={() => updateInventoryQuantity(item.id, 1)}
                                                style={{ width: 36, height: 36, backgroundColor: 'white', borderRadius: 8, alignItems: 'center', justifyContent: 'center' }}
                                            >
                                                <Ionicons name="add-outline" size={20} color="#0088CC" />
                                            </TouchableOpacity>
                                        </View>
                                    </View>
                                ))}
                ...
                <View style={{
                    ...
                    >
                        <Text style={{ color: '#0F172A', fontSize: 15, fontWeight: '700' }}>{afterPhoto ? "Change photo" : "Take photo"}</Text>
                    </TouchableOpacity>
                </View>
