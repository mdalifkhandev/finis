    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: THEME.colors.background }} edges={['top']}>
            ...
            <View style={{
                ...
                <Text style={{ fontSize: 18, fontWeight: '700', color: THEME.colors.textMain }}>Terms & Condition</Text>
            </View>
            ...
            >
                ...
                <Text style={{
                    ...
                    By accessing or using this application or service, you agree to be bound by these Terms and Conditions. If you do not agree with any part of these terms, you must not use the application or service.
                </Text>
