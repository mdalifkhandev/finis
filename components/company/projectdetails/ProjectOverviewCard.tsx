  ...
  return (
    <View className="mx-5 mt-6 overflow-hidden rounded-[14px] bg-[#225879] p-3">
      ...
      <View className="flex-row items-center">
        ...
        <View className="ml-3">
          <Text className="text-[16px] font-semibold text-white">Riverside Tower</Text>
      ...
      <View className="mt-3 rounded-xl bg-[rgba(136,175,201,0.45)] px-3.5 py-3">
        <View className="flex-row items-center">
          <Ionicons name="location-outline" size={20} color="#EAF2F8" />
        ...
        <View className="mt-2.5 flex-row items-center">
          <Ionicons name="business-outline" size={20} color="#EAF2F8" />
          <Text className="ml-3 text-[14px] text-white">Horizon Builders Inc.</Text>
        </View>

        <View className="mt-2.5 flex-row items-center">
          <Ionicons name="globe-outline" size={20} color="#EAF2F8" />
          <Text className="ml-3 text-[14px] text-white">2025-08-01 - Ongoing</Text>
        </View>
      </View>
      ...
      <View className="mt-3 flex-row justify-between">
        ...
        >
          <Text className="text-[14px] font-medium text-[#111827]">Floor plan</Text>
        </TouchableOpacity>
        <TouchableOpacity
          activeOpacity={0.86}
          className="h-10 w-[48.5%] items-center justify-center rounded-[10px] bg-[#F2F4F6]"
        >
          <Text className="text-[14px] font-medium text-[#111827]">Edit Project</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
