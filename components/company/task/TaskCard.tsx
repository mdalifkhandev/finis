    ...
    <View className="mt-2.5 rounded-xl border border-[#D6DBE2] bg-[#F7F9FB] px-3.5 py-3.5">
      ...
      <View className="mt-2 flex-row items-center justify-between">
        <View className="flex-row items-center">
          ...
          <Text className="ml-1.5 text-[14px] text-[#4C596C]">{task.location}</Text>
        </View>

        <View className="flex-row items-center">
          <Ionicons name="calendar-outline" size={16} color="#4C596C" />
          <Text className="ml-1.5 text-[14px] text-[#4C596C]">{task.startDate}</Text>
        </View>
      </View>
      ...
      <View className="mt-2 flex-row items-center justify-between">
        <View className="flex-row items-center">
          ...
          <Text className="ml-1.5 text-[14px] text-[#4C596C]">{task.assignee}</Text>
        </View>

        <View className="flex-row items-center">
          <Ionicons name="time-outline" size={16} color="#4C596C" />
          <Text className="ml-1.5 text-[14px] text-[#4C596C]">{task.dueDate}</Text>
        </View>
      </View>
