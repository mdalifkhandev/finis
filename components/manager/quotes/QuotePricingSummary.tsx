  ...
  return (
    <>
      <QuoteSectionCard title="Quote Summary" icon="document-text-outline">
        <Text className="text-[16px] font-semibold text-[#1F2328]">
          {estimate.title}
        </Text>
        ...
        <View className="mt-4 rounded-[12px] bg-[#F6F9FB] p-3">
          ...
          <Text className="mt-1 text-[14px] font-medium text-[#1F2328]">
      ...
      <QuoteSectionCard title="Selected Work Totals" icon="cash-outline">
        <View className="mb-3 flex-row items-center justify-between rounded-[10px] bg-[#F9FBFC] px-3 py-3">
          ...
          <Text className="text-[13px] font-semibold text-[#1F5577]">
            {itemsSelected}
          </Text>
        </View>
        <View className="mb-3 flex-row items-center justify-between rounded-[10px] bg-[#F9FBFC] px-3 py-3">
        ...
        <View className="rounded-[12px] bg-[#1F5577] px-4 py-4">
          ...
          <Text className="mt-1 text-[24px] font-semibold text-white">
            {formatCurrency(estimatedTotal)}
          </Text>
        </View>
      </QuoteSectionCard>
      ...
      <View className="mt-4 flex-row gap-3">
        <TouchableOpacity
          activeOpacity={0.88}
          onPress={onBack}
          className="h-[52px] flex-1 items-center justify-center rounded-[12px] border border-[#D6DCE3] bg-white"
        >
          <Text className="text-[15px] font-medium text-[#2B2B2B]">Back</Text>
        </TouchableOpacity>
        <TouchableOpacity
          activeOpacity={0.88}
          className="h-[52px] flex-1 items-center justify-center rounded-[12px] bg-[#1F5577]"
        >
